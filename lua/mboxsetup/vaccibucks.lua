...
callbacks.Register("CreateMove", function(cmd)
    ...
    if EnableVacciBucks then
        -- Enable VacciBucks functionality
        autoWalkEnabled = true
        shouldGuidePlayer = true
        AddNotification("VacciBucks Auto Walk enabled by Helper!", "success")

        -- Reset the flag after enabling
        EnableVacciBucks = false
    end
    CheckServerChange()
...
function StartVacciExploit()
    EnableVacciBucks = true
end

function StopVacciExploit()
    ForceCleanup()
end
